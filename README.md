...
[![PyPI version](https://img.shields.io/badge/version-1.2.3-blue.svg)](https://pypi.org/project/auto-gen-py-project/)
...
Core generation does not require an LLM. The `auto_gen_py_project.ai.AIProvider` interface allows future plugins to recommend templates, enrich specs, and generate snippets without changing the generator.

```bash
auto-gen-py-project new Shop --ai "FastAPI inventory service with Docker"
```
